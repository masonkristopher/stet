 ...
 * problems panel, and search results, which window identically; DiffView's wheel stays bespoke (a
 * horizontal axis, wrap gating, its own steps). Callers pass `state` accessors as closures, the
 * same shape as an inline handler.
 */
